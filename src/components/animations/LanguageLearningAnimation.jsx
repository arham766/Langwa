      ...
      >
        ...
        >
          ...
          <g>
            ...
            />
            <rect x="210" y="110" width="280" height="180" rx="5" fill="white" />
            ...
            <g>
              ...
              {/* Language Text */}
              {[
                { x: 213, text: "Hello", color: "#6b21a8" },
                { x: 310, text: "Hola", color: "#7e22ce" },
                { x: 410, text: "Bonjour", color: "#9333ea" }
              ].map((item, index) => (
                <motion.text
                  key={index}
                  x={item.x}
        ...
        <motion.g
          ...
          initial={{ x: 370, y: 160 , opacity: 0 }}
          animate={{ x: 550, y: 200 , opacity: 1 }}
